...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/ext-4.2.1/resources/css/ext-all' + suffix + '.css"/>');
    }
    document.write('<script type="text/javascript" src="' + path + '/ext-4.2.1/ext-all.js"></script>');
    ...
    if (neptune) {
        ...
        neptunePath = (repoDevMode ? path + '/..' : path) +
            '/ext-4.2.1/packages/ext-theme-classic/build/ext-theme-classic' +
            (repoDevMode ? '-dev' : '') + '.js';
