 ...
 * 下拉树类(Jelly)
 */
Ext.define('Jxgl.swjgtree.ComboSwjgTree', {
	...
	config : {
		...
		store : Ext.create('Ext.data.TreeStore', {
					...
					proxy : {
						...
						extraParams : {
							id : authorityDeptId //'13706000000'
						},
						reader : {
							type : 'json',
							root : 'records'
	...
	setValue : function(value) {
		...
		try {
			var hasOwnProp = me.store.hasOwnProperty('getRootNode');
			record = value ? me.store.getNodeById(value) : (hasOwnProp
					? me.store.getRootNode()
					: null);
